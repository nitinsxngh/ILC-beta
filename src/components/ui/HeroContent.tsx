    ...
    return (
        <div className="w-full h-screen flex items-center justify-center px-6 md:px-16 relative" onMouseMove={handleMouseMove}>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center">
                ...
                <p className="hero-text-2 text-sm lg:text-lg bg-clip-text text-transparent bg-gradient-to-b text-white py-4 max-w-md">
                    Customized Learning for Your Unique Experience.
                </p>
                <button
                    type="button"
                    className="hero-button text-sm px-4 py-2 bg-white text-black rounded-full creativeBtn w-fit"
