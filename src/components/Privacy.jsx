    ...
    <main className="legal-page">
      <div className="legal-container">
        ...
        <p className="legal-meta">
          <strong>Innovative ILC India Private Limited</strong> | <strong>www.ilc.limited</strong>
        </p>
        ...
        <section className="legal-section">
          ...
          <p>ILC uses your information to:</p>
          <ul>
            <li>Register and maintain your account and deliver all platform services</li>
            <li>Conduct psychometric assessments and generate your Career Kundli</li>
            <li>Issue, update, and maintain your DigiLocker-verified Career ID</li>
            <li>Build your AI-powered, ATS-optimised CV from your verified profile</li>
            ...
            <li>Improve platform performance through anonymised usage analysis</li>
          </ul>
          <p>
            You grant ILC a non-exclusive, worldwide, royalty-free right to use your data for the
            purposes described in this Policy. Such use does not amount to a violation of any
            rights you may have in your information.
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            sell or commercially exploit your personal data to advertisers or data brokers.
          </p>
        </section>

        <section className="legal-section">
          <h2>5. DigiLocker Verification</h2>
          <p>
            ILC uses the Government of India’s DigiLocker framework via Meri Pehchan solely to
            authenticate your Career ID. Your DigiLocker login credentials are never stored by ILC.
            Verification is initiated only with your explicit consent. You may withdraw consent at
            any time, though this may affect your Career ID’s verified status.
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <ul>
            <li>
              Technical, financial, commercial, or operational information relating to ILC’s
              business, methods, accounts, products, and security procedures
            </li>
            <li>
              Psychometric frameworks, assessment algorithms, Career ID architecture, and platform
              infrastructure details
            </li>
            <li>Personal information of other users, clients, mentors, or institutional partners</li>
            <li>All data, notes, summaries, or materials derived from the above</li>
          </ul>
          ...
          <ul>
            ...
            <li>Was already known to the user prior to disclosure by ILC on a non-confidential basis</li>
            <li>Is received by the user from a third party not subject to confidentiality obligations</li>
          ...
          <h3>6.3 User Obligations</h3>
          <p>You agree and undertake that:</p>
          <ul>
            <li>
              All Confidential Information shall remain the sole property of ILC and shall be
              treated as a trade secret
            </li>
            <li>
              You shall hold all Confidential Information in strict confidence and not disclose it
              to any third party or use it for any purpose beyond your engagement with the platform
            </li>
            <li>
              You shall employ all reasonable measures to protect Confidential Information from
              unauthorised or inadvertent disclosure
            </li>
            <li>You shall restrict internal access to Confidential Information on a need-to-know basis</li>
            <li>
              Your confidentiality obligations shall survive the termination or expiry of your use
              of the platform for a period of one year
            </li>
          </ul>
        </section>
        ...
        <section className="legal-section">
          ...
          <p>
            Despite these measures, no digital platform can guarantee absolute security. Users are
            advised to maintain strong passwords, avoid sharing login credentials, and immediately
            report any suspected unauthorised access to <strong>integratedlearningcircle@gmail.com</strong>.
          </p>
        </section>

        <section className="legal-section">
          <h2>8. Right to Erasure &amp; Retention</h2>
          <p>
            Users may request deletion of their account and personal data by emailing{' '}
            <strong>integratedlearningcircle@gmail.com</strong>. Data will be permanently deleted
            within 30 days of a verified request. Financial records are retained for 7 years as
            required by Indian law. Certain data may be retained where required by ongoing legal
            obligations.
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <p>
            This Policy may be updated from time to time. Users are required to keep themselves
            informed of the current Policy. By accessing the platform, you are deemed to have
            accepted the most current version. Material changes will be communicated via email or
            platform notice.
          </p>
        </section>
