                        ...
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    ...
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">Ready to start your journey with ILC? Reach out to us—we'd love to hear from you and help you achieve your career goals.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col xl:flex xl:flex-row gap-15 xl:gap-48">
                        <div className="max-w-md flex flex-col gap-9 md:gap-16">
                            <div className="flex flex-col gap-5 md:gap-8">
                                <p className="max-w-2xl text-secondary/70 dark:text-white/70">Connect with us to explore opportunities, ask questions, or learn more about how ILC can support your career development and professional growth.</p>
                            </div>
                        </div>
