            ...
            <div className="bg-secondary py-10 md:py-20 xl:py-40">
                <div className="container">
                    <div className="flex flex-col xl:flex-row gap-10 xl:gap-0">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-full gap-10 md:gap-8">
                            <ul className='flex flex-col gap-1.5'>
                                <li className='text-white font-semibold text-lg mb-2'>{footerData?.whatWeProvide?.title}</li>
                                {footerData && footerData?.whatWeProvide?.items?.map((value: any, index: any) => {
                                    return (
                                        <li key={index}>
                            ...
                            <ul className='flex flex-col gap-1.5'>
                                <li className='text-white font-semibold text-lg mb-2'>{footerData?.toolsByILC?.title}</li>
                                {footerData && footerData?.toolsByILC?.items?.map((value: any, index: any) => {
                                    return (
                                        <li key={index}>
                                            <a href={value.href} className='text-lg text-white hover:text-primary'>{value.name}</a>
                                        </li>
                            ...
                            <ul className='flex flex-col gap-1.5'>
                                <li className='text-white font-semibold text-lg mb-2'>{footerData?.buildConnections?.title}</li>
                                {footerData && footerData?.buildConnections?.items?.map((value: any, index: any) => {
                                    return (
                                        <li key={index}>
                                            <a href={value.href} className='text-lg text-white hover:text-primary'>{value.name}</a>
                                        </li>
                            ...
                            <div className='flex flex-col gap-4'>
                                ...
                                <p className='text-white/70 text-base'>{footerData && footerData?.copyright}</p>
                            </div>
                        </div>
